...
import com.yuri.mykey.login.LockPatternView.Cell;
import com.yuri.mykey.login.LockPatternView.DisplayMode;
import com.yuri.mykey.login.LockPatternView.OnPatternListener;
...
public class LockPatternActivity extends Activity implements OnClickListener, OnPatternListener, OnLongClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		isFirst = sp.getBoolean(KeyUtil.PATTERN_INIT_KEY, true);
	...
	public void onClick(View v) {
		...
		case R.id.right_button:
			...
			editor.putBoolean(KeyUtil.PATTERN_INIT_KEY, false);
			editor.commit();
			break;
		...
		new AlertDialog.Builder(this)
			...
			.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Editor editor = sp.edit();
					editor.putBoolean(KeyUtil.PATTERN_INIT_KEY, true);
					editor.commit();
				}
			})
	...
	public void onPatternDetected(List<Cell> pattern) {
		...
		if(!isFirst){
			...
			if (result!= 1) {
				...
				intent.setClass(LockPatternActivity.this, KeyLoader.class);
